...
@Autonomous(name = "AutonomousCFar")
public class AutonomousCFar extends LinearOpMode {
    ...
    public void straightFoward( double inches, double power ) {
    ...
    public void turnHeadingFoward(double power) {
        while ( opModeIsActive() && angle >=-45 && angle <=1 ) {
