...
@Autonomous
public class AutonomousClose1Line extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            shootClassifierA();
            degreesFirstLine();
            fowardFirstLine_fast(20,0.8);
            fowardFirstLine(22, 0.3);
    ...
    public void degreesFirstLine() {
        while (opModeIsActive() && imu.getHeading(AngleUnit.DEGREES) >= -29) {
            s_midintake.setPower(0);
            m_bl.setPower(-.7);
            m_br.setPower(.8);
            m_fl.setPower(-.8);
    ...
    public void GyroClassify1() {
        ...
        while (opModeIsActive() && imu.getHeading(AngleUnit.DEGREES) <= -6) {
            m_bl.setPower(.7);
            m_br.setPower(-.8);
            m_fl.setPower(.7);
            m_fr.setPower(-.8);
